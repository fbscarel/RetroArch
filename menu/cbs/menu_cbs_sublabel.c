...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_input_all_users_control_hotkeys,  MENU_ENUM_SUBLABEL_INPUT_ALL_USERS_CONTROL_HOTKEYS)
      ...
      switch (cbs->enum_idx)
      {
        ...
        case MENU_ENUM_LABEL_PLAY_REPLAY:
         ...
         case MENU_ENUM_LABEL_INPUT_HOTKEY_FOLLOWS_PLAYER1:
            ...
            break;
         case MENU_ENUM_LABEL_INPUT_ALL_USERS_CONTROL_HOTKEYS:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_input_all_users_control_hotkeys);
            break;
